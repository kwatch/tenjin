...
for item in items:
    ...
    _extend(('''    <tr class="''', str(n % 2 and 'odd' or 'even'), '''">
     ...
     <td>
      <strong>''', str(item.s_price), '''</strong>
     </td>\n''', ));
    if item.change < 0.0:
        _extend(('''     <td class="minus">''', str(item.s_change), '''</td>
     <td class="minus">''', str(item.s_ratio), '''</td>\n''', ));
    else:
        _extend(('''     <td>''', str(item.s_change), '''</td>
     <td>''', str(item.s_ratio), '''</td>\n''', ));
    #endif
    _extend(('''    </tr>\n''', ));
